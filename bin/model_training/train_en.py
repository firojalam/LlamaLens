...
# nohup accelerate launch /workspace/llamalens/scripts/train_en.py \
...
#   --grad_size 2 \
#   --epochs 2 \
#   --out_dir "/workspace/llamalens/trained_models/Llamalens_EN_28_1_25/outputs" \
#   --save_steps 500 \
#   --train_set_dir "/workspace/llamalens/data/finetuning_datasets/native_tuning_datasets/TRAIN_ONLY_ENGLISH" \
...
#   --lora_adapter_dir "/workspace/llamalens/trained_models/Llamalens_EN_28_1_25/lora_adapter" \
#   --merged_model_dir "/workspace/llamalens/trained_models/Llamalens_EN_28_1_25/merged_model" \
#   > /workspace/llamalens/output_en.log 2>&1 &
